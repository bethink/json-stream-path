...
class StreamJPathTest < Test::Unit::TestCase
  ...
  def test_parsing_whole
    stream = File.open('stream_example.json')
  ...
  #stream = File.open('stream_example.json')
  #@parser = JSON::Stream::Parser.new
  #hash = @parser.parse(stream, '/root')
  #
  #
  #stream = File.open('stream_example.json')
  #@parser = JSON::Stream::Parser.new
  #hash = @parser.parse(stream, '/root/one')
  #
  #stream = File.open('stream_example.json')
  #@parser = JSON::Stream::Parser.new
  #hash = @parser.parse(stream, '/root/two')
  #
  #stream = File.open('stream_example.json')
  #@parser = JSON::Stream::Parser.new
  #hash = @parser.parse(stream, '/root/three')
  #
  #stream = File.open('stream_example.json')
  #@parser = JSON::Stream::Parser.new
  #hash = @parser.parse(stream, '/root/three/three1')
  #
  #stream = File.open('stream_example.json')
  #@parser = JSON::Stream::Parser.new
  #hash = @parser.parse(stream, '/root/three/three2')
